...
class DetectionPipeline:
    ...
    def __init__(self, detector=mtcnn, n_frames=None, batch_size=60, resize=None):
...
def image_predictor (image_path):
    ...
    # Manually define the feature extractor parameters
    ...
    print(f"The image is predicted to be: {id2label[predicted_class_idx]}")

    prediction_image=id2label[predicted_class_idx]

    result=f"The given Image is : {prediction_image}"
